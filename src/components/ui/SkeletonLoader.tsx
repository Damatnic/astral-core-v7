...
export const PaymentFormSkeleton = ({ className }: { className?: string }) => (
  <div className={clsx('max-w-md mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow', className)}>
...
export const AppointmentListSkeleton = ({ count = 3, className }: { count?: number; className?: string }) => (
  <div className={clsx('space-y-3', className)}>
    {Array.from({ length: count }).map((_, index) => (
      <div key={index} className="border-l-4 border-gray-200 dark:border-gray-600 pl-4 py-3 animate-pulse">
...
export const ListItemSkeleton = ({ 
  ...
  <div className={clsx('space-y-4', className)}>
    {Array.from({ length: count }).map((_, index) => (
      <div key={index} className="flex items-start space-x-3 p-4 bg-white dark:bg-gray-800 rounded-lg shadow animate-pulse">
        {showAvatar && (
