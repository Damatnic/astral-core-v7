...
export const ErrorDisplay = ({
  ...
  return (
    <div
      className={clsx(getVariantStyles(), getSizeStyles(), className)}
      role='alert'
      aria-live='polite'
    >
      <div className='flex items-start'>
        ...
        <div className={clsx('flex-1', showIcon && 'ml-3')}>
          <h3 className={clsx('text-sm font-medium', getTextColor())}>{title}</h3>
          ...
          <div className={clsx('mt-1', getTextColor())}>
            ...
            {context && (
              <p className='text-xs mt-1 opacity-75' id='error-context'>
                Context: {context}
              </p>
            )}
          </div>
