      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              <Link href="/admin/users" className="block p-3 border rounded hover:bg-gray-50 dark:hover:bg-gray-700">
                Manage Users
              </Link>
              <Link href="/admin/therapists" className="block p-3 border rounded hover:bg-gray-50 dark:hover:bg-gray-700">
                Manage Therapists
              </Link>
              <Link href="/admin/audit" className="block p-3 border rounded hover:bg-gray-50 dark:hover:bg-gray-700">
                Audit Logs
              </Link>
              <Link href="/admin/settings" className="block p-3 border rounded hover:bg-gray-50 dark:hover:bg-gray-700">
                System Settings
              </Link>
            </div>
          </div>
        ...
        <div className="mt-8 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <div>
              <p className="text-sm font-semibold text-gray-600 dark:text-gray-300">HIPAA Compliance</p>
              <p className="text-green-600 font-bold">✓ Compliant</p>
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-600 dark:text-gray-300">Last Security Audit</p>
              <p className="font-bold">3 days ago</p>
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-600 dark:text-gray-300">Data Encryption</p>
